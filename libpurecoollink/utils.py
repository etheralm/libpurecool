...
from .const import DYSON_PURE_HOT_COOL_LINK_TOUR, \
    DYSON_360_EYE, DYSON_PURE_COOL, DYSON_PURE_COOL_DESK
...
def is_pure_cool_v2(product_type):
    ...
    :param product_type Dyson device model
    """
    if product_type in [DYSON_PURE_COOL, DYSON_PURE_COOL_DESK]:
        return True
    return False
...
def is_dyson_pure_cool_device(json_payload):
    ...
    if json_payload['ProductType'] in [DYSON_PURE_COOL, DYSON_PURE_COOL_DESK]:
        return True
    return False
